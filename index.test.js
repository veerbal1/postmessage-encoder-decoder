...
describe('BHMessenger v1: Encoder', () => {
  ...
  it('should return a protocol as bighappy', () => {
    expect(obj.protocol).toBe('bighappy');
  });
  ...
  it('should return correct encoded string', () => {
    expect(obj.encode({})).toBe('bighappy://v1/{}');
    expect(obj.encode({})).toBe('bighappy://v1/{}');
    expect(
      obj.encode({
        action: 'test',
    ...
    ).toBe('bighappy://v1/{"action":"test","data":{"content":""}}');
  });
});
...
describe('BHMessenger v2: Encoder', () => {
  ...
  it('should return correct encoded string', () => {
    expect(obj.encode({})).toBe('bighappy://v2/{}');
    expect(obj.encode({})).toBe('bighappy://v2/{}');
    expect(
      obj.encode({
        action: 'test',
    ...
    ).toBe('bighappy://v2/{"action":"test","data":{"content":""}}');
  });
});
...
describe('BHMessenger v1: Decoder', () => {
  ...
  it('should throw an error if version is not valid', () => {
    expect(() => obj.decode('bighappy://v3/{}')).toThrow('Unsupported version');
  }),
    it('should return correct decoded object', () => {
      expect(obj.decode('bighappy://v1/{}')).toEqual({});
      expect(
        obj.decode('bighappy://v1/{"action":"test","data":{"content":""}}')
      ).toEqual({
        action: 'test',
        data: {
          content: '',
...
describe('BHMessenger v2: Decoder', () => {
  ...
  it('should throw an error if version is not valid', () => {
    ...
    it('should return correct decoded object', () => {
      expect(obj.decode('bighappy://v2/{}')).toEqual({});
      expect(
        obj.decode('bighappy://v2/{"action":"test","data":{"content":""}}')
      ).toEqual({
        action: 'test',
        data: {
          content: '',
